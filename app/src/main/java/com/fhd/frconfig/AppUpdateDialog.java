        ...
        tvUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             ...
             //       context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + appPackageName)));
                context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.bizmotion.walton" + appPackageName)));
                } catch (ActivityNotFoundException activityNotFoundException) {
               //     context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + appPackageName)));
                 context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https:https://play.google.com/store/apps/details?id=com.bizmotion.walton")));
                }
            }
        });
